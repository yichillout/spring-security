...
public class UserControllerTest {
	...
	public void whenQuerySuccess() throws Exception {
		String result = mockMvc
				.perform(MockMvcRequestBuilders.get("/user").param("username", "Jasper")
						.contentType(MediaType.APPLICATION_JSON_UTF8))
				.andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.jsonPath("$.length()").value(3)).andReturn().getResponse()
				.getContentAsString();

		System.out.println("UserControllerTest : whenQuerySuccess" + result);
	}
	...
	public void whenGetInfoSuccess() throws Exception {
		String result = mockMvc
				...
				.andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.jsonPath("$.username").value("James")).andReturn().getResponse()
				.getContentAsString();
	...
	public void whenCreateSuccess() throws Exception {
		Date date = new Date();
		System.out.println("post send : date.getTime : " + date.getTime());
		String content = "{\"username\":\"James\",\"password\":null,\"birthday\":" + date.getTime() + "}";
		String result = mockMvc
	...
	public void whenUpdateSuccess() throws Exception {
		...
		System.out.println("post send : date.getTime : " + date.getTime());
		String content = "{\"id\":\"1\",\"username\":\"Jasper\",\"password\":null,\"birthday\":" + date.getTime() + "}";
		// String content =
		// "{\"id\":\"1\",\"username\":\"James\",\"password\":null,\"birthday\":" +
		// date.getTime() + "}";
		String result = mockMvc
	...
	@Test
	public void whenGetConditionQuerySuccess() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.get("/user/condition").param("username", "Penny").param("age", "18")
	...
	@Test
	public void whenUploadFileSuccess() throws UnsupportedEncodingException, Exception {
		String result = mockMvc
				.perform(MockMvcRequestBuilders.fileUpload("/file")
				.file(new MockMultipartFile("file", "test.txt", "multipart.form-data","upload testing".getBytes("UTF-8"))))
